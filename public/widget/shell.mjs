...
export function renderShell(container) {
  ...
  // Someday Somehow: drop the expand (fullscreen) and enable/disable toggle
  // controls; keep only the help "?". They're still created and returned below
  // so the mount/expand wiring stays valid — they're just never put in the DOM.
